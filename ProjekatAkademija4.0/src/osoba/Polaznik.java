...
public class Polaznik extends Osoba implements Meni, Serializable
{
	...
	public void printStecenaZnanja()
	{
		...
		int brojac = 1;
		for(OcjenjiveKompetencije ocj: stecenaZnanja) {
	...
	//meni za polaznika koji se poziva unutar akademije tokom modifikacije polaznika
	@Override
	public void opcije()
	{
		boolean izlaz = true;
